...
-- Users (password_hash is nullable; demo login uses 'inventory123' fallback)
...
-- Products  (uses supplier TEXT + image_url TEXT — matches updated schema)
insert into products (id, name, sku, category, brand, price, cost_price, barcode, qr_payload, variants, batch_number, expiry_date, reorder_level, supplier, image_url, stock, status) values
  ('10000000-0000-0000-0000-000000000001', 'AeroTrack RFID Tag Pack',    'SKU-AER-0001', 'Electronics',  'AeroTrack',  1199.00,  650.00, '890100000001', 'SKU-AER-0001', '[{"size":"50-pack","color":"Graphite"}]',              'AT-2404', '2028-04-30', 120, 'Northstar Components', 'https://images.unsplash.com/photo-1581090700227-1e37b190418e?w=800', 580,  'In Stock'),
  ('10000000-0000-0000-0000-000000000002', 'NovaScan Wireless Scanner',  'SKU-NOV-0002', 'Hardware',     'NovaScan',   8499.00, 5100.00, '890100000002', 'SKU-NOV-0002', '[{"size":"Standard","color":"Black"}]',               'NS-2405', '2029-01-20',  25, 'Northstar Components', 'https://images.unsplash.com/photo-1587825140708-dfaf72ae4b04?w=800',  65,  'Low Stock'),
  ('10000000-0000-0000-0000-000000000003', 'ColdChain Label Roll',       'SKU-COL-0003', 'Packaging',    'PrimePack',   449.00,  210.00, '890100000003', 'SKU-COL-0003', '[{"size":"1000 labels","color":"White"}]',             'CC-2402', '2027-08-15', 300, 'Prime Packaging Co.',  'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=800', 920,  'In Stock'),
  ('10000000-0000-0000-0000-000000000004', 'Retail Shelf Sensor',        'SKU-RET-0004', 'IoT',          'ShelfSense', 3299.00, 1990.00, '890100000004', 'SKU-RET-0004', '[{"size":"Mini","color":"Silver"},{"size":"Pro","color":"Black"}]', 'RS-2401', '2028-11-10', 60, 'Urban Retail Supply',  'https://images.unsplash.com/photo-1519389950473-47ba0277781c?w=800',  54,  'Low Stock'),
  ('10000000-0000-0000-0000-000000000005', 'Thermal Printer Ribbon',     'SKU-THE-0005', 'Consumables',  'PrintEdge',   799.00,  360.00, '890100000005', 'SKU-THE-0005', '[{"size":"110mm x 300m","color":"Black"}]',            'TP-2406', '2027-12-01', 180, 'Prime Packaging Co.',  'https://images.unsplash.com/photo-1581091870627-3f619f8d999f?w=800', 175,  'In Stock')
...
-- Orders  (uses supplier TEXT + customer TEXT instead of old supplier_id/customer_name FKs)
insert into orders (id, order_number, type, status, supplier, customer, source_warehouse_id, destination_warehouse_id, items, total_amount, created_by, expected_at) values
  ('20000000-0000-0000-0000-000000000001', 'PO-2026-1001', 'PURCHASE', 'APPROVED',   'Northstar Components', null,             null,                                  'aaaaaaaa-1111-1111-1111-aaaaaaaaaaaa', 3, 125000.00, '22222222-2222-2222-2222-222222222222', now() + interval '4 days'),
  ('20000000-0000-0000-0000-000000000002', 'SO-2026-2042', 'SALE',     'DISPATCHED', null,                   'BrightMart Retail', 'cccccccc-3333-3333-3333-cccccccccccc', null,                                  5,  87950.00, '33333333-3333-3333-3333-333333333333', now() + interval '1 day'),
  ('20000000-0000-0000-0000-000000000003', 'TO-2026-0312', 'TRANSFER', 'RECEIVED',   null,                   null,             'aaaaaaaa-1111-1111-1111-aaaaaaaaaaaa', 'bbbbbbbb-2222-2222-2222-bbbbbbbbbbbb', 2,      0.00, '33333333-3333-3333-3333-333333333333', now() - interval '2 days')
