...
insert into suppliers (id, name, contact_person, email, phone, address, city, country, payment_terms, lead_time_days, is_active) values
  ('55555555-0000-0000-0000-000000000001', 'Northstar Components', 'Rohan Bose',  'supply@northstar.example', '+91 98765 10001', 'Plot 14, MIDC',           'Pune',      'India', 'Net 30', 5, true),
  ('55555555-0000-0000-0000-000000000002', 'Urban Retail Supply',  'Amrita Sen',  'ops@urbanretail.example',  '+91 98765 10002', 'Sector 63 Industrial',   'Noida',     'India', 'Net 15', 8, true),
  ('55555555-0000-0000-0000-000000000003', 'Prime Packaging Co.',  'Dev Nair',    'orders@primepack.example', '+91 98765 10003', 'Bidadi Industrial Area', 'Bengaluru', 'India', 'Net 21', 6, true),
  ('55555555-0000-0000-0000-000000000004', 'Medley Cold Chain',    'Simran Gill', 'dispatch@medley.example',  '+91 98765 10004', 'Sanand GIDC',            'Ahmedabad', 'India', 'Net 30', 9, true);
...
insert into products (
  ...
  ('10000000-0000-0000-0000-000000000001', 'SKU-AER-0001', 'AeroTrack RFID Tag Pack', 'Tamper-resistant RFID tags for cartons and shelf bins.', 'ca000000-0000-0000-0000-000000000001', '55555555-0000-0000-0000-000000000001', 'pack', 650.00, 1199.00, 120, 360, '890100000001', 'SKU-AER-0001', true,  false, 'https://images.unsplash.com/photo-1581090700227-1e37b190418e?w=800', true),
  ('10000000-0000-0000-0000-000000000002', 'SKU-NOV-0002', 'NovaScan Wireless Scanner', 'Bluetooth handheld barcode scanner for picking stations.', 'ca000000-0000-0000-0000-000000000002', '55555555-0000-0000-0000-000000000001', 'unit', 5100.00, 8499.00, 25, 80, '890100000002', 'SKU-NOV-0002', true,  false, 'https://images.unsplash.com/photo-1587825140708-dfaf72ae4b04?w=800', true),
  ('10000000-0000-0000-0000-000000000003', 'SKU-COL-0003', 'ColdChain Label Roll', 'Temperature-safe label rolls for chilled shipments.', 'ca000000-0000-0000-0000-000000000004', '55555555-0000-0000-0000-000000000003', 'roll', 210.00, 449.00, 300, 900, '890100000003', 'SKU-COL-0003', true,  true, 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=800', true),
  ('10000000-0000-0000-0000-000000000004', 'SKU-RET-0004', 'Retail Shelf Sensor', 'IoT shelf sensor with hourly stock-presence telemetry.', 'ca000000-0000-0000-0000-000000000003', '55555555-0000-0000-0000-000000000002', 'unit', 1990.00, 3299.00, 60, 180, '890100000004', 'SKU-RET-0004', true,  false, 'https://images.unsplash.com/photo-1519389950473-47ba0277781c?w=800', true),
  ('10000000-0000-0000-0000-000000000005', 'SKU-THE-0005', 'Thermal Printer Ribbon', 'Wax-resin ribbon for thermal transfer printers.', 'ca000000-0000-0000-0000-000000000005', '55555555-0000-0000-0000-000000000003', 'roll', 360.00, 799.00, 180, 540, '890100000005', 'SKU-THE-0005', true,  true, 'https://images.unsplash.com/photo-1581091870627-3f619f8d999f?w=800', true),
  ('10000000-0000-0000-0000-000000000006', 'SKU-MED-0006', 'ColdPack Gel Brick', 'Reusable gel brick for pharma cold-chain cartons.', 'ca000000-0000-0000-0000-000000000004', '55555555-0000-0000-0000-000000000004', 'unit', 95.00, 180.00, 500, 1500, '890100000006', 'SKU-MED-0006', true, true, 'https://images.unsplash.com/photo-1581093458791-9d42e252f7d4?w=800', true);
...
insert into purchase_orders (id, po_number, supplier_id, warehouse_id, status, order_date, expected_date, received_date, total_amount, notes, created_by) values
  ('20000000-0000-0000-0000-000000000001', 'PO-2026-1001', '55555555-0000-0000-0000-000000000001', 'aaaaaaaa-1111-1111-1111-aaaaaaaaaaaa', 'received',  current_date - interval '7 days', current_date - interval '2 days', current_date - interval '1 day', 182000.00, 'RFID tags and scanner replenishment', '22222222-2222-2222-2222-222222222222'),
  ('20000000-0000-0000-0000-000000000002', 'PO-2026-1002', '55555555-0000-0000-0000-000000000003', 'bbbbbbbb-2222-2222-2222-bbbbbbbbbbbb', 'confirmed', current_date - interval '1 day', current_date + interval '5 days', null, 189000.00, 'Monthly label roll replenishment', '22222222-2222-2222-2222-222222222222');
